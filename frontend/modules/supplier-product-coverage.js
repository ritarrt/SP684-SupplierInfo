...
function resetRow(row) {
  ...
  if (catText) catText.textContent = "- เลือก -";
...
function onCategoryChange(radio) {
  ...
  row.querySelector(".brand-display span").textContent = "- เลือกแบรนด์ -";
  row.querySelector(".group-display span").textContent = "- เลือกกลุ่มสินค้า -";
